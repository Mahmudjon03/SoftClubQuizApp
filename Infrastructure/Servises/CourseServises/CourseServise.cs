...
namespace Infrastructure.Servises.CourseServises;
    ...
    public async Task<Response<GetCourseDto>> DeleteCourse(int id)
    {
        ...
        if (course == null) return new Response<GetCourseDto>("Course Not Found");
        ...
        return new Response<GetCourseDto>("Successfuly Delete Course");
    ...
    public async Task<Response<GetCourseDto>> UpdateCourse(AddCourseDto model)
    {
        ...
        if (course == null) return new Response<GetCourseDto>(HttpStatusCode.NotFound);
